...
"This is your workflow, in your words." Walk the pill bar left to right. The red pills are the stages where the pain lives; the notes above each one name the cost in your words. Point at the return arc under the last stretch: the resubmit → PRC review loop is where weeks disappear.

## 5 · The same workflow, with Redline in it
Same bar, same stages. Advance from slide 4 and let the room see the diff: the red pills turn green, and the yellow band underneath is what Redline now carries. Say the boundary out loud: human approval and the Veeva submission stay with your team. This is the payoff of the opening arc; give it a beat.
...
## 14 · Carries approved changes (THE EDITOR)
